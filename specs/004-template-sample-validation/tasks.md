...
- **User Story 3 (Phase 5)**: Depends on US1 (Phase 3 — same reason; the failure-path tests load the use case). T022 / T023 / T024 / T025 / T026 / T027 can run in parallel.
...
3. Developer C: US3 tests (T022 → T027).
4. Developer D: US4 test (T028) + Polish (T029 → T033).
