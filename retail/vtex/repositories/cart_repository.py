...
class CartRepository:
    ...
    def mark_notification_sent(cart: Cart) -> Cart:
        ...
        which is consumed by the abandoned-cart conversion check to compare
        against the VTEX order creationDate.
    ...
    def find_abandoned_cart_for_conversion(
        ...
        A cart is eligible when it:
        1. Matches the given order_form_id and project
        2. Has integrated_agent set
        3. Has notification_sent_at populated (notification was delivered)
        4. Has not yet had its conversion reported to CAPI
        ...
        Returns:
            The matching Cart instance if eligible for conversion tracking,
            or None otherwise.
        """
