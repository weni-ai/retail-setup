...
from retail.agents.serializers import (PushAgentSerializer,
                                       ReadAgentSerializer,
                                       ReadIntegratedAgentSerializer)
from retail.agents.tasks import validate_pre_approved_templates
from retail.agents.usecases import (AssignAgentUseCase, ListAgentsUseCase,
...
class AssignAgentView(APIView):
    ...
    def post(self, request: Request, agent_uuid: UUID) -> Response:
        ...
        integrated_agent, raw_client_secret = use_case.execute(agent, project_uuid, credentials)
