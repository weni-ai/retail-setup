...
class ValidateAgentRulesTaskTest(TestCase):
    def setUp(self):
    ...
    @patch("retail.agents.domains.agent_management.tasks.ValidateAgentRulesUseCase")
    def test_validate_agent_rules_success(self, mock_use_case_class):
        mock_use_case = MagicMock()
        mock_use_case_class.return_value = mock_use_case

        agents_ids = [str(self.agent1.uuid), str(self.agent2.uuid)]

        validate_agent_rules(agents_ids)
    ...
    @patch("retail.agents.domains.agent_management.tasks.ValidateAgentRulesUseCase")
    def test_validate_agent_rules_with_nonexistent_agent_ids(self, mock_use_case_class):
        mock_use_case = MagicMock()
        mock_use_case_class.return_value = mock_use_case
    ...
    @patch("retail.agents.domains.agent_management.tasks.ValidateAgentRulesUseCase")
    def test_validate_agent_rules_with_empty_list(self, mock_use_case_class):
        mock_use_case = MagicMock()
        mock_use_case_class.return_value = mock_use_case
