...
class AgentOrderStatusUpdateUsecaseTest(TestCase):
    ...
    @patch("retail.agents.usecases.order_status_update.settings")
    @patch("retail.agents.usecases.order_status_update.cache")
    @patch("retail.agents.usecases.order_status_update.IntegratedAgent")
    ...
    @patch("retail.agents.usecases.order_status_update.cache")
    @patch("retail.agents.usecases.order_status_update.Project")
    ...
    @patch("retail.agents.usecases.order_status_update.AgentWebhookUseCase")
    @patch("retail.agents.usecases.order_status_update.RequestData")
    @patch(
        "retail.agents.usecases.order_status_update.adapt_order_status_to_webhook_payload"
    )
